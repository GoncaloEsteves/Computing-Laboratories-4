...
{ 
    ...
    { 
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _VehicleInfo: ").Append(_VehicleInfo).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((VehicleInfo)obj);
        }
        ...
        public bool Equals(VehicleInfo other)
        {
            ...
            return 
                ...
                (
                    _VehicleInfo == other._VehicleInfo ||
                    _VehicleInfo != null &&
                    _VehicleInfo.Equals(other._VehicleInfo)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + _VehicleInfo.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(VehicleInfo left, VehicleInfo right)
        {
